...
class Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [_renderInformation(), _renderFooter()]);
  }
  ...
  Widget _renderInformation() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Image.asset("assets/images/vinfast-logo-footer.png", width: 150),
          SizedBox(height: 15),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text:
                          '0108926276 do Sở KHĐT TP Hà Nội cấp lần đầu ngày 01/10/2019 và các lần thay đổi tiếp theo.',
                      style: TextStyle(
